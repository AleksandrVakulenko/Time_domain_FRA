...
Estimations_1 = TDFRA_fit_core.estimation_processing(Ch_data_1);
Estimations_2 = TDFRA_fit_core.estimation_processing(Ch_data_2);
...
[Result_2, Residuals_2, DEBUG_2] = TDFRA_fit_core.fit_channel(T_arr_2, V2_arr, ...

...
Amp_full = poly3calc2(Result.amp_poly, T_arr);
Phi_full = poly3calc2(Result.phi_poly, T_arr);
BG_full = poly3calc2(Result.bg_poly, T_arr);

Amp = poly3calc2(Result.amp_poly, T_arr_min);
Phi = poly3calc2(Result.phi_poly, T_arr_min);
BG = poly3calc2(Result.bg_poly, T_arr_min);

Amp_err = poly3calc_err2(Result.amp_poly_err, T_arr_min);
Phi_err = poly3calc_err2(Result.phi_poly_err, T_arr_min);
BG_err = poly3calc_err2(Result.bg_poly_err, T_arr_min);

...
tic
[Amp_DFT, Phi_DFT] = TDFRA_fit_core.DFT_single_freq(Time, Signal, 1);
disp(['A = ' num2str(Amp_DFT) ' V  |  P = ' num2str(Phi_DFT) ' deg'])
[Amp_DFT, Phi_DFT] = TDFRA_fit_core.DFT_single_freq(Time, Signal, 50);
disp(['A = ' num2str(Amp_DFT) ' V  |  P = ' num2str(Phi_DFT) ' deg'])
[Amp_DFT, Phi_DFT] = TDFRA_fit_core.DFT_single_freq(Time, Signal, 10);
disp(['A = ' num2str(Amp_DFT) ' V  |  P = ' num2str(Phi_DFT) ' deg'])
toc

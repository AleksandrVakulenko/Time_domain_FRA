...
% FIXME: Aster specific function !

function Result = show_result_debug_2(Result_1, Result_2, freq, R_Scale, Range_N)
...
Res_err = sqrt(Res_err.^2 + Amp_cal_err.^2);
Phase_diff_error = sqrt(Phase_diff_error.^2 + Phi_cal_err.^2);
